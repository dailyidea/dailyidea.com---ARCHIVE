<template>
  <div>
    ...
    <desktop-sub-header></desktop-sub-header>
    ...
    >
      ...
      <template v-slot:default="rotationStyle">
        <idea-card
          ref="page"
          :style="rotationStyle"
          @expand-toggle="isExpanded = !isExpanded"
        >
          <Welcome v-if="welcomeMode" :page-on="ideaIndex"></Welcome>

          <v-col v-if="!welcomeMode" cols="12" md="8" class="idea-part">
          ...
          <v-col v-if="!welcomeMode" cols="12" md="4">
            <idea-comments
