<template>
  <static-page>
    ...
    <p>
      ...
      <a href="https://www.dailyidea.com/">https://www.dailyidea.com/</a>, one
      of our main priorities is the privacy of our visitors. This Privacy Policy
      document contains types of information that are collected and recorded by
      Daily Idea and how we use it.
    </p>
    <p>
    ...
    <p>
      ...
      and/or collect in Daily Idea. This policy is not applicable to any
    ...
    <p>
      Daily Idea follows a standard procedure of using log files. These files
    ...
    <p>
      Like any other website, Daily Idea uses 'cookies'. These cookies are used
    ...
    <p>
      ...
      advertising partners of the Daily Idea.
    </p>
    <p>
      Third-party ad servers or ad networks uses technologies like cookies,
      JavaScript, or Web Beacons that are used in their respective
      advertisements and links that appear on Daily Idea, which are sent
    ...
    <p>
      Note that Daily Idea has no access to or control over these cookies that
      are used by third-party advertisers.
    </p>

    <h2>Third Party Privacy Policies</h2>
    <p>
      Daily Idea's Privacy Policy does not apply to other advertisers or
    ...
    <p>
      Daily Idea does not knowingly collect any Personal Identifiable
