<template>
  <static-page>
    ...
    <p>
      ...
      <a href="https://www.dailyidea.com/">https://www.dailyidea.com/</a>, you
    ...
    <p>
      ...
      Daily Idea's Website for personal, non-commercial transitory viewing only.
    ...
    <ul>
      ...
      <li>
        attempt to reverse engineer any software contained on Daily Idea's
        Website;
      </li>
      <li>
    ...
    <p>
      This will let Daily Idea terminate upon violations of any of these
    ...
    <h2>3. Disclaimer</h2>
    <p>
      All the materials on Daily Idea’s Website are provided "as is". Daily Idea
      makes no warranties, may it be expressed or implied, therefore negates all
      other warranties. Furthermore, Daily Idea does not make any
    ...
    <h2>4. Limitations</h2>
    <p>
      Daily Idea or its suppliers will not be held accountable for any damages
      that will arise with the use or inability to use the materials on Daily
      Idea’s Website, even if Daily Idea or an authorized representative of this
    ...
    <p>
      The materials appearing on Daily Idea’s Website may include technical,
      typographical, or photographic errors. Daily Idea will not promise that
      any of the materials in this Website are accurate, complete, or current.
      Daily Idea may change the materials contained on its Website at any time
      without notice. Daily Idea does not make any commitment to update the
      materials.
    </p>
    <h2>6. Links</h2>
    <p>
      Daily Idea has not reviewed all of the sites linked to its Website and is
      not responsible for the contents of any such linked site. The presence of
      any link does not imply endorsement by Daily Idea of the site. The use of
      any linked website is at the user’s own risk.
    </p>
    <h2>7. Site Terms of Use Modifications</h2>
    <p>
      Daily Idea may revise these Terms of Use for its Website at any time
