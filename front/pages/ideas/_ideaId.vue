  ...
  <Layout v-bind="{
    ...
    <v-layout id="ideaDetailPage">
      ...
      <v-flex class="profileDetails">
        ...
        <div v-else class="ideaEditor">
          <v-combobox v-model="chips" class="ideaTag" :items="items" chips clearable multiple>
      ...
      <div class="pageFooter">
        ...
        <div>
          <v-icon class="sendBtn" @click="showcommentDialog = true" v-on="on">fas fa-arrow-right</v-icon>
        </div>
        <!--
        ...
        <v-dialog v-model="showcommentDialog" content-class="commentDialog" persistent max-width="300px">
          <form>
            <!-- Popup Header -->
            <div class="header">
              <div>
